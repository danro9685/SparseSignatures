...
my_seed_cross_validation = 32411
...
save(evaluate_lambda_range_germline_cv_10,file="paper_final_experiments/evaluate_lambda_range_our_germline_nmf_lasso_cv_10.RData")
...
save(nmfLlasso_cv_germline_cv_10,file="paper_final_experiments/nmfLlasso_cv_germline_cv_10_our_germline_nmf_lasso_cv_10.RData")
