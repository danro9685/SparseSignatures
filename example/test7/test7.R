...
load("data/initial_betas_germline_cv_10_control_not_TN.RData")
...
for(i in 1:nrow(initial_betas_germline_cv_10)) {
    ...
    # NMF standard
    curr_alpha_nmf_standard = array(0,c(372,(i+3)))
...
# save the results
save(nmf_results,file="example/test7/nmf_results.RData")
