...
#' @import ggplot2
#'
"plot.patient" <- function( countMatrix, patientName, xlabels = TRUE, freq = FALSE ) {
...
#' @return A ggplot2 object
#' @export plot.signatures
#' @import data.table
#' @import ggplot2
#' @import gridExtra
#'
"plot.signatures" <- function( beta, useColNames = TRUE, firstBackground = TRUE, xlabels = TRUE ) {
