...
SparseSignatures & De Novo Mutational Signature Discovery in Tumor Genomes using SparseSignatures & \href{https://www.biorxiv.org/content/early/2018/08/04/384834}{Publication}\\ \hline
...
patient.plots(countMatrix=imported_data,patientName="PD10010a")
@
